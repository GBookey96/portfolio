        ...
        <div className="AboutMe">
            ...
            <div className="ContentContainer">
                ...
                <div className="TextContainer">
                    ...
                    <p>My educational journey took me on a profound path of self-discovery and learning. After completing my basic education, I spent six transformative years immersing myself in the study of religious texts and philosophy at various educational institutions across London, Gateshead, and Jerusalem. These years were instrumental in deepening my understanding of different spiritual traditions, and they instilled in me a strong commitment to lifelong learning.</p>

                    <p>One of the most significant milestones in my personal life was when I got married in December 2019. The joyous occasion took place in Melbourne, Australia, where my wife and I resided for nearly a year. It was during this time that we welcomed the arrival of our precious son, Yanky, who brought immense joy and blessings to our lives.</p>
